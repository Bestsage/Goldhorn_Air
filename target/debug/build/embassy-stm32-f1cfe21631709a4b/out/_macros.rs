...
macro_rules! foreach_flash_region {
    ($($pat:tt => $code:tt;)*) => {
        ...
        __foreach_flash_region_inner!((OTPRegion,4,528));
    };
}#[allow(unused)]
macro_rules! foreach_interrupt {
    ($($pat:tt => $code:tt;)*) => {
        ...
        __foreach_interrupt_inner!((TIM10,timer,TIM_GP16,BRK,TIM1_UP_TIM10));
        __foreach_interrupt_inner!((TIM10,timer,TIM_GP16,CC,TIM1_UP_TIM10));
        __foreach_interrupt_inner!((TIM10,timer,TIM_GP16,COM,TIM1_UP_TIM10));
        __foreach_interrupt_inner!((TIM10,timer,TIM_GP16,TRG,TIM1_UP_TIM10));
        __foreach_interrupt_inner!((TIM10,timer,TIM_GP16,UP,TIM1_UP_TIM10));
        __foreach_interrupt_inner!((TIM11,timer,TIM_GP16,BRK,TIM1_TRG_COM_TIM11));
        __foreach_interrupt_inner!((TIM11,timer,TIM_GP16,CC,TIM1_TRG_COM_TIM11));
        __foreach_interrupt_inner!((TIM11,timer,TIM_GP16,COM,TIM1_TRG_COM_TIM11));
        __foreach_interrupt_inner!((TIM11,timer,TIM_GP16,TRG,TIM1_TRG_COM_TIM11));
        __foreach_interrupt_inner!((TIM11,timer,TIM_GP16,UP,TIM1_TRG_COM_TIM11));
        ...
        __foreach_interrupt_inner!((TIM9,timer,TIM_GP16,BRK,TIM1_BRK_TIM9));
        __foreach_interrupt_inner!((TIM9,timer,TIM_GP16,CC,TIM1_BRK_TIM9));
        __foreach_interrupt_inner!((TIM9,timer,TIM_GP16,COM,TIM1_BRK_TIM9));
        __foreach_interrupt_inner!((TIM9,timer,TIM_GP16,TRG,TIM1_BRK_TIM9));
        __foreach_interrupt_inner!((TIM9,timer,TIM_GP16,UP,TIM1_BRK_TIM9));
...
macro_rules! foreach_dma_channel {
    ($($pat:tt => $code:tt;)*) => {
        ...
        __foreach_dma_channel_inner!((DMA1_CH0,DMA1,dma,0,0,{}));
        __foreach_dma_channel_inner!((DMA1_CH1,DMA1,dma,1,1,{}));
        __foreach_dma_channel_inner!((DMA1_CH2,DMA1,dma,2,2,{}));
        __foreach_dma_channel_inner!((DMA1_CH3,DMA1,dma,3,3,{}));
        __foreach_dma_channel_inner!((DMA1_CH4,DMA1,dma,4,4,{}));
        __foreach_dma_channel_inner!((DMA1_CH5,DMA1,dma,5,5,{}));
        __foreach_dma_channel_inner!((DMA1_CH6,DMA1,dma,6,6,{}));
        __foreach_dma_channel_inner!((DMA1_CH7,DMA1,dma,7,7,{}));
        __foreach_dma_channel_inner!((DMA2_CH0,DMA2,dma,0,8,{}));
        __foreach_dma_channel_inner!((DMA2_CH1,DMA2,dma,1,9,{}));
        __foreach_dma_channel_inner!((DMA2_CH2,DMA2,dma,2,10,{}));
        __foreach_dma_channel_inner!((DMA2_CH3,DMA2,dma,3,11,{}));
        __foreach_dma_channel_inner!((DMA2_CH4,DMA2,dma,4,12,{}));
        __foreach_dma_channel_inner!((DMA2_CH5,DMA2,dma,5,13,{}));
        __foreach_dma_channel_inner!((DMA2_CH6,DMA2,dma,6,14,{}));
        __foreach_dma_channel_inner!((DMA2_CH7,DMA2,dma,7,15,{}));
    };
}#[allow(unused)]
